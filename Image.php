...
<br><br><br><br><br><br>
   ...
   <?php
       ...
       echo '<div  id="ii"  >';
   $requete1 ="select Id_Categorie from Categorie where Libelle_Categorie='Images & Sons'";
    ...
    echo '<div class="card">
      <img src="'.$ligne2->Photo.'" style="width:100%">
        ...
        <p class="price_promo" style="color:#33eb3e; font-size:18pt">'.$ligne2->Prix_Promo.' MAD</p>
         ...
         <button><a href="panier.php?id='.$ligne2->Id_produit.'" name="mm" > <i class="fa fa-plus" style="font-size:25px"></i><i class="fas fa-shopping-cart2"style="font-size: 25px; "></i> </a></button>         </div>';
   }
}
   ?>
